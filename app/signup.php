...
<body>
    <div class="main-container container">
        ...
        <div class="welcome-container">
            ...
            <p>Join us today and unlock endless possibilities. Our platform is designed to provide an engaging and seamless experience for everyone.</p>
        ...
        <div class="login-container">
            ...
            <form id="loginForm">
                ...
                <div class="form-step">
                    <input type="email" id="email" name="email" class="form-control" placeholder="Enter an email address" required>
                </div>
                <div class="form-step">
                ...
                <div class="form-step">
                    <button type="submit" name="signup" class="btn submit-btn">Sign up</button>
                </div>
                <!-- Navigation -->
